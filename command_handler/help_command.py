def help(update, context):
    ...
    update.message.reply_text(
        ...
        "/okboomer : Je t'envoie une image du subreddit /r/okboomer.\n"
        "/reddit mildlyinteresting : Choisis un subreddit et je t'envoie une image correspondante.\n"
        "/judge Anna : Donne moi le nom de quelqu'un et je lancerai un sondage pour que vous puissiez le juger bien gratuitement alors qu'il n'avait rien demandé.\n"
        "/spongebob du texte : jE SaIs pAs cOmMeNt uTiLiSeR UnE CoMmAnDe tElEgRaM"
        "\n"
        "Sinon je parle aussi parfois sans qu'on me le demande, mais vous verrez bien."
    )
